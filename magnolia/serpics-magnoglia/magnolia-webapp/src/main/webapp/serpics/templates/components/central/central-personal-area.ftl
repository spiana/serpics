	...
	<div  ng-if="currentUser.userType=='REGISTERED'" ng-init="getOrders(); getCountryList()">
		...
		<div class="col-sm-12 clearfix" style="margin-bottom: 30px;">
						<div class="col-sm-4 clearfix">
							...
							<input ng-show="modify != 'contact'" type="submit" value="Modify contact address" class="btn btn-primary" ng-click="getRegionByCountry(currentUser.contactAddress.country.id); modify = 'contact'">
						</div>
							<div class="col-sm-4 form-one clearfix" style="width: 33.33333333%;">
								<form>	
							...
							<div class="col-sm-4 form-two clearfix" style="margin-left: 0%;width: 33.33333333%;" >
								<form>
									<select ng-disabled="modify != 'contact'" ng-options="country as country.iso3Code for country in countries track by country.iso3Code" ng-model="currentUser.contactAddress.country" ng-change="getRegionByCountry(currentUser.contactAddress.country.id)">
										<option value ="" disabled>-- Country --</option>
									</select>
									<select ng-show="modify != 'contact'" ng-disabled="modify != 'contact'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.contactAddress.region" >
										<option value = "" >{{currentUser.contactAddress.region.name || '-- Region --'}}</option>
									</select>
									<select ng-show="modify === 'contact'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.contactAddress.region" >
		...
		<div class="col-sm-12 clearfix" style="margin-bottom: 30px;" >
						<div class="col-sm-4 clearfix">
							...
							<input ng-show="modify != 'billing'" type="submit" value="Modify billing address" class="btn btn-primary" ng-click="getRegionByCountry(currentUser.billingAddress.country.id); modify = 'billing'">
						</div>
							<div class="col-sm-4 form-one clearfix" style="width: 33.33333333%;">
								<form>	
							...
							<div class="col-sm-4 form-two clearfix" style="margin-left: 0%;width: 33.33333333%;" >
								<form>
									<select ng-disabled="modify != 'billing'" ng-options="country as country.iso3Code for country in countries track by country.iso3Code" ng-model="currentUser.billingAddress.country" ng-change="getRegionByCountry(currentUser.billingAddress.country.id)">
										<option value ="" disabled>-- Country --</option>
									</select>
									<select ng-show="modify != 'billing'" ng-disabled="modify != 'billing'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.billingAddress.region" >
										<option value = "" >{{currentUser.billingAddress.region.name || '-- Region --'}}</option>
									</select>
									<select ng-show="modify === 'billing'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.billingAddress.region" >
										<option value = "" >-- Region --</option>
									</select>
		...
		<div class="col-sm-12 clearfix" style="margin-bottom: 30px;" ng-init="$scope.shippingAddress = -1">
						...
						<div>
							<div class="col-sm-4 clearfix" ng-show="$scope.shippingAddress === -1">
								...
								<input ng-show="modify != 'shipping'" type="submit" value="Modify shipping address" class="btn btn-primary" ng-click="getRegionByCountry(currentUser.destinationAddress[$scope.shippingAddress].country.id); modify = 'shipping'">							
							</div>
							<div class="col-sm-4 clearfix" ng-hide="$scope.shippingAddress === -1">
								...
								<input ng-show="modify != 'shipping'" type="submit" value="Modify shipping address" class="btn btn-primary" ng-click="getRegionByCountry(currentUser.destinationAddress[$scope.shippingAddress].country.id); modify = 'shipping'">
								<input type="submit" value="Remove address" class="btn btn-primary" ng-click="deleteDestinationAddress(currentUser.destinationAddress[$scope.shippingAddress].uuid); $scope.shippingAddress = -1; modify = ''">
							</div>
								<div class="col-sm-4 form-one clearfix" style="width: 33.33333333%;">
									<form>
							...
							<div class="col-sm-4 form-two clearfix" style="margin-left: 0%;width: 33.33333333%;" >
									<form>
									<select ng-disabled="modify != 'shipping'" ng-options="country as country.iso3Code for country in countries track by country.iso3Code" ng-model="currentUser.destinationAddress[$scope.shippingAddress].country" ng-change="getRegionByCountry(currentUser.destinationAddress[$scope.shippingAddress].country.id)">
										<option value ="" disabled>-- Country --</option>
									</select>
									<select ng-show="modify != 'shipping'" ng-disabled="modify != 'billing'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.destinationAddress[$scope.shippingAddress].region" >
										<option value = "" >{{currentUser.destinationAddress[$scope.shippingAddress].region.name || '-- Region --'}}</option>
									</select>
									<select ng-show="modify === 'shipping'" ng-options="region as region.name for region in regions track by region.name" ng-model="currentUser.destinationAddress[$scope.shippingAddress].region" >
										<option value = "" >-- Region --</option>
									</select>
