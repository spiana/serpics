...
CREATE TABLE `orderitems` (
  ...
  KEY `FK_70c653e8c07949c38f5e47f0b35` (`shipmode_id`),
  ...
  CONSTRAINT `FK_70c653e8c07949c38f5e47f0b35` FOREIGN KEY (`shipmode_id`) REFERENCES `shipmode` (`shipmode_id`)
...
CREATE TABLE `orders` (
  ...
  KEY `FK_4e287b86ddc1405c9424d5bb5d0` (`shipmode_id`),
  ...
  CONSTRAINT `FK_4e287b86ddc1405c9424d5bb5d0` FOREIGN KEY (`shipmode_id`) REFERENCES `shipmode` (`shipmode_id`),
...
CREATE TABLE `shipmode` (
  ...
  UNIQUE KEY `UK_fa8a36105f3e4f00b2aed71c4e8` (`uuid`),
  UNIQUE KEY `UK_2f4290cb88a64ca3a59f40b7eb1` (`name`),
  KEY `FK_1edff32fb50c45f493adcaa201d` (`name_string_id`),
  CONSTRAINT `FK_1edff32fb50c45f493adcaa201d` FOREIGN KEY (`name_string_id`) REFERENCES `multilingual_string` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shipmodelookup` (
  ...
  KEY `FK_2ba675da6ea941bea9e40cfd5e6` (`shipmode_id`),
  ...
  CONSTRAINT `FK_2ba675da6ea941bea9e40cfd5e6` FOREIGN KEY (`shipmode_id`) REFERENCES `shipmode` (`shipmode_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shipping` (
  ...
  KEY `FK_f32e98255edf4d77aaa4e7af4bc` (`shipmode_id`),
  CONSTRAINT `FKE13ADDAE6C1E9E18` FOREIGN KEY (`currency_id`) REFERENCES `currency` (`currency_id`),
  CONSTRAINT `FK_f32e98255edf4d77aaa4e7af4bc` FOREIGN KEY (`shipmode_id`) REFERENCES `shipmode` (`shipmode_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `suborders` (
  ...
  KEY `FK_be2cead66a824f338344fa2e06e` (`shipmode_id`),
  CONSTRAINT `FK18A97125814345F9` FOREIGN KEY (`orders_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `FK_be2cead66a824f338344fa2e06e` FOREIGN KEY (`shipmode_id`) REFERENCES `shipmode` (`shipmode_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-01-27 17:53:12
