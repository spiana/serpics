...
app.controller("categoryController",['$scope','$cookies','authManagerService','categoryService','$timeout', 
    ...
    function($scope,$cookies,authManagerService,categoryService,$timeout) {	
	     ...
	     * sessikon id is created and added to a hidden field , if we
		...
		$scope.getTop = function() {	
			$scope.createSessionId()
            		categoryService.getTop($scope.sessionId).then( function( response ) {
