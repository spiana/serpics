...
//	var mockedLog =console.log.bind(console);
	...
	//1 Dichiaro i moduli che mi servono per i test
		beforeEach(module('cart.service','http.mocks','serpics.services', function($provide) {
	...
	beforeEach(inject( function($q,serpicsServices,$cookies){
	 ...
	 xit('cartService cartUpdate(cartItem) with mocked getSessionId function', inject(function(cartService,$httpBackend) {
	  ...
	  xit('cartService addBillingAddress(billingAddress) with mocked getSessionId function', inject(function(cartService,$httpBackend) {
	  ...
	  xit('cartService addShippingAddress(shippingAddress) with mocked getSessionId function', inject(function(cartService,$httpBackend) {
