...
@DefaultSpec(CtentryMedia.class)
public class DefaultCtentryMediaSpecification implements Specification<CtentryMedia>{
	@Autowired
	CommerceEngine engine;
	

	@Override
	public Predicate toPredicate(Root<CtentryMedia> root, CriteriaQuery<?> cq,
			CriteriaBuilder cb) {
