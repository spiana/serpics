...
public class BasicCrudView<T> extends AbsoluteLayout implements
	...
	public BasicCrudView(Class<T> entityClass, final EntityManager em) {
	...
	protected void initContainer() {
		container = JPAContainerFactory.make(getEntityClass(), em);
//		JPAContainerFactory.make(entityClass, entityManager)
