...
/**
 * The persistent class for the orders_attribute_value_decimal database table.
 * 
 */
@Entity
@Table(name = "orders_attribute_value_decimal")
public class OrdersAttributeValueDecimal extends com.serpics.core.persistence.jpa.AbstractEntity implements Serializable {
	...
	public OrdersAttributeValueDecimal() {
	}
