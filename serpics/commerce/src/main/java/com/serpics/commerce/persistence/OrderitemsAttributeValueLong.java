...
/**
 * The persistent class for the orderitems_attribute_value_long database table.
 * 
 */
@Entity
@Table(name = "orderitems_attribute_value_long")
public class OrderitemsAttributeValueLong extends com.serpics.core.persistence.jpa.AbstractEntity implements Serializable {
	...
	public OrderitemsAttributeValueLong() {
	}
