...
public class PriceStrategyImpl extends AbstractStrategy implements PriceStrategy {
	...
	@Override
	public Double resolveProductPrice(BaseProduct product, Currency currency) throws PriceNotFoundException{
	...
	@Override
	public Double resolveProductCost(BaseProduct product, Currency currency) throws PriceNotFoundException{
		Price price = priceService.findProductPrice(product , currency);
